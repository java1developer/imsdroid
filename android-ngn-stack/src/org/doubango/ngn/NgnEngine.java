...
public class NgnEngine {
    ...
    protected NgnEngine() {
        ...
        mNotifManager = (NotificationManager) NgnApplication.getInstance().getSystemService(Context.NOTIFICATION_SERVICE);
        mVibrator = null;
    ...
    public synchronized boolean start() {
        ...
        if (success) {
            ...
            NgnApplication.getInstance().startService(new Intent(NgnApplication.getInstance(), getNativeServiceClass()));
        } else {
    ...
    public synchronized boolean stop() {
        ...
        NgnApplication.getInstance().stopService(new Intent(NgnApplication.getInstance(), getNativeServiceClass()));
