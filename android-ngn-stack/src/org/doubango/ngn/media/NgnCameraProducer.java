...
public class NgnCameraProducer {
    ...
    static {
        NgnCameraProducer.useFrontFacingCamera = NgnApplication.getInstance()
                .getNgnEngine()
                .getConfigurationService()
                .getBoolean(NgnConfigurationEntry.GENERAL_USE_FFC, NgnConfigurationEntry.DEFAULT_GENERAL_USE_FFC);
    }
